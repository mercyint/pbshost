...
if (!$j("link[href='https://cdn.rawgit.com/mercyint/pbshost/v1.0.3/plugins/css/overlay.css']").length){
    $j('<link href="https://cdn.rawgit.com/mercyint/pbshost/v1.0.3/plugins/css/overlay.css" rel="stylesheet">').appendTo("head");
}
